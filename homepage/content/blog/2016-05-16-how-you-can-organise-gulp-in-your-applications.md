...
![How you can organise gulp in your applications](https://offeringsolutionscdn.blob.core.windows.net/$web/img/articles/wp-content/uploads/2016/05/gulpAndConfigFile.png 'gulptask folder')
...
![alt text](https://offeringsolutionscdn.blob.core.windows.net/$web/img/articles/wp-content/uploads/2016/05/folderGulpTasks.png 'gulptask folder')
...
![tasks output](https://offeringsolutionscdn.blob.core.windows.net/$web/img/articles/wp-content/uploads/2016/05/gulpTasks.png 'gulp task output')
