...
![Azure Dashboard Create New Storage Account](https://offeringsolutionscdn.blob.core.windows.net/$web/img/articles/2020-08-09/1.png)

You can give it a name

![Azure Dashboard Naming New Storage Account](https://offeringsolutionscdn.blob.core.windows.net/$web/img/articles/2020-08-09/2.png)
...
![Azure Storage Account Resource Container Button](https://offeringsolutionscdn.blob.core.windows.net/$web/img/articles/2020-08-09/3.png)

We create a new container, set it to "Public access level" _"Blob"_ and give it a name. `firstcontainer` in this case.

![Azure Storage Account Resource Container Button](https://offeringsolutionscdn.blob.core.windows.net/$web/img/articles/2020-08-09/4.png)

Then click "Create".

Inside of the container you can see no files yet, we will upload them with Angular and ASP.NET Core. Read on 😉

![Azure Storage Account Resource Inside Container](https://offeringsolutionscdn.blob.core.windows.net/$web/img/articles/2020-08-09/5.png)
...
![Azure Storage Account Connection String](https://offeringsolutionscdn.blob.core.windows.net/$web/img/articles/2020-08-09/6.png)
...
![Angular App showing the uploaded picture](https://offeringsolutionscdn.blob.core.windows.net/$web/img/articles/2020-08-09/7.png)

And we can see the file in the blob container.

![Azure Container showing the uploaded picture](https://offeringsolutionscdn.blob.core.windows.net/$web/img/articles/2020-08-09/8.png)
